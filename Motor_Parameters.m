...
b = 0.01; % motor viscous friction constant (N.m.s)
J = 0.0007; % moment of inertia of the rotor (kg.m^2)
Ke = 0.0734; % electromotive force constant 
Kt = 0.076;    % motor torque constant 
